...
Create 1 service
Create array with items to buy.
Create empty array to store items that have been bought.
Bind arrays.
Check if to buy list is empty, show message if true.
Check if bought list is empty, show message if true.
